...
# Zmienne pomocnicze do obliczenia średniej liczby osób w kolejce
szwk_suma = 0       # suma: jaki_czas_upłyną_od_zmiany_liczby_osób_w_kolejce * liczba_zdarzeń_w_kolejce
szwk_czas = 0       # czas od ostatniej zmiany liczby zdarzen w kolejce
...
print("Srednia liczba zdarzen w kolejce (test):" + str(szwk_suma/acs))

print("-" * 40)
print()
# Niestety ale ten kod generuje dużo za dużo zdarzeń. Przydałoby się to usprawnić, żeby
for i in range(200):
